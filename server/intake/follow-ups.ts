...
export const selectIntakeFollowUps = (extraction: IntakeExtraction): IntakeFollowUp[] => {
  ...
  // Ask only for facts required by the primary pathway. Contributor presence is
  // already sufficient for the housing solver; collecting a full secondary
  // assessment here delays value without changing its result.
  ...
  if (extraction.primaryBarrier === 'housing') {
